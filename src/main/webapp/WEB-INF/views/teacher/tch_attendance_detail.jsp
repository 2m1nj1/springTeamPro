     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container container-fluid">
     			...
     			<!--페이지 명 -->
				<h5 class="h3 mb-4 text-gray-800">[강사]학생 출결 상세 조회</h5>
									...
									<div class="col-7"> <!-- 해당 강의 출석 누계 -->
										<div class="card shadow mb-4">
		                               		...
		                               		<div class="card-body"> <!-- card-body - 날짜 표시랑 출석현황 버튼들 지정 -->
												...
												<div class="my-2"></div>
												<div class="row">
												    <label class="col-sm-2 col-form-label">출석 현황</label>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered" id="gradeTable" width="100%" cellspacing="0">
                                        ...
                                        <!-- 시험 성적 데이터 출력 (동적으로 생성)  이 부분은 출결 부분으로 바꿔서 생성-->
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<div class="col-8"> <!-- 강사님께 쪽지보내기 버튼 -->
															<a href="comm_insertMessage.do" class="btn btn-primary btn-icon-split btn">
																<span class="icon text-white-50">
																	<i class="fas fa-paper-plane"></i>
																</span>
